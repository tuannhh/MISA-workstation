...
defineProps({ detail: { type: Object, required: true }, canEdit: Boolean, canDelete: Boolean, deleteWorking: Boolean, deleteError: String, uploading: Boolean, fileError: String });
const emit = defineEmits(['back', 'edit', 'delete', 'upload']); const deleteOpen = ref(false);
</script>
