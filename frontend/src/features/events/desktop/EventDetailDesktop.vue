...
defineProps({ detail: { type: Object, required: true }, canEdit: Boolean, canDelete: Boolean, deleteWorking: Boolean, deleteError: String });
const emit = defineEmits(['back', 'edit', 'delete']); const deleteOpen = ref(false);
</script>
