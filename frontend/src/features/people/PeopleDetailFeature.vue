...
<template>
  ...
  <PeopleDetailPageMobile v-else-if="isNative" :detail="state.detail" :bookings="state.bookings?.rows || []" :booking-total="state.bookings?.totalAmount" :booking-error="state.bookingError" :booking-deleting-id="state.bookingDeletingId" :booking-delete-error="state.bookingDeleteError" :can-create-bookings="canCreateBookings" :can-edit-booking="canEditBooking" :can-edit="canEdit" :can-delete="canDelete" :delete-working="state.deleting" :delete-error="state.deleteError" :can-manage-id-docs="canManageIdDocs" :attachment-working="state.attachmentWorking" :attachment-error="state.attachmentError" :safe-area-style="safeAreaStyle" @back="goBack" @edit="state.mode = 'edit'" @create-booking="state.mode = 'booking-create'" @edit-booking="beginBookingEdit" @delete-booking="deleteBooking" @delete-person="deletePerson" @upload="uploadAttachments" @set-primary="setPrimaryAttachment" @delete-attachment="deleteAttachment" />
  ...
  <PeopleDetailPage v-else :detail="state.detail" :bookings="state.bookings?.rows || []" :booking-total="state.bookings?.totalAmount" :booking-error="state.bookingError" :booking-deleting-id="state.bookingDeletingId" :booking-delete-error="state.bookingDeleteError" :can-create-bookings="canCreateBookings" :can-edit-booking="canEditBooking" :can-edit="canEdit" :can-delete="canDelete" :delete-working="state.deleting" :delete-error="state.deleteError" :can-manage-id-docs="canManageIdDocs" :attachment-working="state.attachmentWorking" :attachment-error="state.attachmentError" @back="goBack" @edit="state.mode = 'edit'" @create-booking="state.mode = 'booking-create'" @edit-booking="beginBookingEdit" @delete-booking="deleteBooking" @delete-person="deletePerson" @upload="uploadAttachments" @set-primary="setPrimaryAttachment" @delete-attachment="deleteAttachment" />
</template>
