...
const props = defineProps({ rows: { type: Array, default: () => [] }, total: { type: Number, default: 0 }, page: { type: Number, default: 1 }, pageSize: { type: Number, default: 20 }, search: { type: String, default: '' }, loading: { type: Boolean, default: false }, canCreate: { type: Boolean, default: false }, canReassign: { type: Function, default: () => false }, safeAreaStyle: { type: Object, default: () => ({}) } });
const emit = defineEmits(['search', 'page', 'create', 'voice', 'back', 'reassign']);
