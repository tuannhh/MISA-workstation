...
const state = reactive({ phase: 'loading', detail: null, record: null, currentUser: null, permissions: null, ownerReassign: null, ownerReassignContext: null, ownerId: null, ownerReassignTarget: null, ownerReassignSaving: false, ownerReassignError: '', error: null, mode: 'read', saving: false, saveError: null, uploading: false, fileError: null });
...
<template>
  ...
  <SupplierDetailPageMobile v-else-if="isNative" :detail="state.detail" :can-edit="canEdit" :can-reassign="canReassign" :can-upload-files="canUploadFiles" :can-open-files="canOpenFiles" :uploading="state.uploading" :file-error="state.fileError" :safe-area-style="safeAreaStyle" @back="goBack" @edit="state.mode = 'edit'" @reassign="beginOwnerReassign" @upload-files="uploadFiles" />
  ...
  <SupplierDetailPage v-else :detail="state.detail" :can-edit="canEdit" :can-reassign="canReassign" :can-upload-files="canUploadFiles" :can-open-files="canOpenFiles" :uploading="state.uploading" :file-error="state.fileError" @back="goBack" @edit="state.mode = 'edit'" @reassign="beginOwnerReassign" @upload-files="uploadFiles" />
