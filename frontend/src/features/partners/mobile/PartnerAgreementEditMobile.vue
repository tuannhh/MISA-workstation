...
import { toAgreementEditDraft, toAgreementUpdatePayload, validateAgreementDraft } from '../domain/partner-cooperation.mjs';
...
function reset() { Object.assign(draft, toAgreementEditDraft(props.record)); initialDraft.value = JSON.stringify(draft); Object.keys(errors).forEach((key) => delete errors[key]); }
