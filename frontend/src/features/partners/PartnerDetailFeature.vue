...
const state = reactive({ phase: 'loading', detail: null, record: null, permissions: null, error: null, mode: 'read', saving: false, saveError: null, deleting: false, deleteError: null, deletingCooperationId: null, cooperationDeleteError: null });
...
<template>
  ...
  <PartnerDetailPageMobile v-else-if="isNative" :detail="state.detail" :can-edit="canEdit" :can-delete="canDelete" :can-create-cooperation="canCreateCooperation" :can-delete-cooperation="canDelete" :deleting-cooperation-id="state.deletingCooperationId" :cooperation-delete-error="state.cooperationDeleteError" :delete-working="state.deleting" :delete-error="state.deleteError" :safe-area-style="safeAreaStyle" @back="goBack" @edit="state.mode = 'edit'" @create-agreement="state.mode = 'agreement-create'" @create-work-log="state.mode = 'work-log-create'" @delete-agreement="deleteAgreement" @delete-work-log="deleteWorkLog" @delete-partner="deletePartner" @navigate="emit('navigate', $event)" />
  ...
  <PartnerDetailPage v-else :detail="state.detail" :can-edit="canEdit" :can-delete="canDelete" :can-create-cooperation="canCreateCooperation" :can-delete-cooperation="canDelete" :deleting-cooperation-id="state.deletingCooperationId" :cooperation-delete-error="state.cooperationDeleteError" :delete-working="state.deleting" :delete-error="state.deleteError" @back="goBack" @edit="state.mode = 'edit'" @create-agreement="state.mode = 'agreement-create'" @create-work-log="state.mode = 'work-log-create'" @delete-agreement="deleteAgreement" @delete-work-log="deleteWorkLog" @delete-partner="deletePartner" @navigate="emit('navigate', $event)" />
</template>
