...
<template>
  ...
  <PartnerFinancialFormMobile v-else-if="isNative && state.mode === 'financial-form'" :entity="state.financialEntity" :record="state.financialRecord" :saving="state.saving" :error="state.saveError" :safe-area-style="safeAreaStyle" @back="state.mode='read'" @save="saveFinancial" @local-error="state.saveError=$event" />
  ...
  <PartnerFinancialFormDesktop v-else-if="state.mode === 'financial-form'" :entity="state.financialEntity" :record="state.financialRecord" :saving="state.saving" :error="state.saveError" @back="state.mode='read'" @save="saveFinancial" @local-error="state.saveError=$event" />
