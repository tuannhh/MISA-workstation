...
| [07-route-catalog.md](07-route-catalog.md) | G0.3 — catalog **150/150 route literal 1:1** + 2 job + 13 UI view, `file:line` (thay bản wildcard-compress cũ, đã bị Codex bắt lỗi; +3 route W1.ADMIN và +2 Voice secure-command) |
| [08-permission-matrix.md](08-permission-matrix.md) | G0.4 — Section A auth partition 150/150 và Section B/C UI-flow/runtime matrix đã PASS C0.3; 36 flow đủ Desktop/Native cho hai role current-state, Native-Mobile trung thực `FAIL/MISSING` |
