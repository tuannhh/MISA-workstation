...
| [07-route-catalog.md](07-route-catalog.md) | G0.3 — catalog **148/148 route literal 1:1** + 2 job + 13 UI view, `file:line` (thay bản wildcard-compress cũ, đã bị Codex bắt lỗi; +3 route batch W1.ADMIN 2026-08-31) |
| [08-permission-matrix.md](08-permission-matrix.md) | G0.4 — Section A auth partition 148/148 và Section B/C UI-flow/runtime matrix đã PASS C0.3; 35 flow đủ Desktop/Native cho hai role current-state, Native-Mobile trung thực `FAIL/MISSING` (F035 thêm batch W1.ADMIN 2026-08-31, backend/API-only) |
