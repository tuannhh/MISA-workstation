...
> **Status:** READ + WRITE-CORE + COOPERATION-CREATE/DELETE IMPLEMENTED / local visual review PASS; chưa cutover sửa/tệp nghiệp vụ con hay Native production.
...
| R011/R014 edit, R016/R017 file sub-resources | Legacy, không claim | Legacy, không claim | N/A batch này | server PolicyEngine | server PolicyEngine | server PolicyEngine |
...
4. `UI-PAR-001..009`, build và regression xanh; rollback = tắt `partnerDetailRead`.
