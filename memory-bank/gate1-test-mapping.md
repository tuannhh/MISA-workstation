...
| BR-CALC-001 | UT-CALC-001 | green | server/test/unit-projections-calculations.test.js | routes.js nsrOf() — công thức Net Sentiment Ratio, 0 khi mẫu số rỗng (trích từ 3 nơi lặp: /monitor/dashboard tổng+trend, /monitor/campaigns/:id/results) |
| BR-CALC-002 | UT-CALC-002 | green | server/test/unit-projections-calculations.test.js | routes.js nsrOf() — làm tròn đúng 2 chữ số thập phân |
| BR-CALC-003 | UT-CALC-003 | green | server/test/unit-projections-calculations.test.js | routes.js careRiskLevel() — đúng biên 5 cấp rủi ro chăm sóc tại 7/14/21/30 ngày (GET /reports) |
| BR-CALC-004 | UT-CALC-004 | green | server/test/unit-projections-calculations.test.js | routes.js bucketOf() — đúng biên mốc 1/3/6/12 tháng, null khi <30 ngày (GET /reports/care-alerts) |
| BR-CALC-005 | UT-CALC-005 | green | server/test/unit-projections-calculations.test.js | routes.js crisisOf() — đúng ngưỡng >=3 tin tiêu cực/24h (GET /monitor/dashboard) |
| BR-CALC-006 | UT-CALC-006 | green | server/test/unit-projections-calculations.test.js | routes.js sentimentScore() — map sắc thái người sửa tay -> điểm, null khi giá trị khác (PUT /monitor/mentions/:id) |
| BR-CALC-007 | UT-CALC-007 | green | server/test/unit-projections-calculations.test.js | routes.js awardCostOf() — tổng chi phí giải thưởng = cost gốc+tổng budget tham gia+chi phí booking (GET /reports/awards) |
| BR-CALC-008 | UT-CALC-008 | green | server/test/unit-projections-calculations.test.js | routes.js awardCostOf() — null-guard cost/participations rỗng, chỉ còn mediaCost |
