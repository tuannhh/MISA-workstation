...
| F2-ratelimit | F2-ratelimit | green | server/test/target-session-f2.test.js | **W1.7 (2026-08-30):** implement thật `server/login-rate-limiter.js` (429 sau 5 lần sai/IP+username trong 15 phút) — promote từ known-red sang assertion xanh thật, entry xoá khỏi `memory-bank/g1b-allowlist.json` |
