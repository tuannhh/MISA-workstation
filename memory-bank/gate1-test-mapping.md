...
| UI-REM-001 | UI-REM-001 | green | server/test/unit-reminders-ui.test.js | W3 Reminders: API payload generic chỉ allowlist field công khai (không nhận subject_id), feature-flag/route explicit, action theo permission server-returned và có Desktop MDS + Native composition riêng. |
