...
> Đây là quy tắc **ĐANG ĐƯỢC TUÂN THEO trong code thật** (rút ra bằng đọc `server/*.js`), không phải quy tắc lý tưởng nên có. Khi có mâu thuẫn/không nhất quán, ghi rõ ra — không che giấu. Quy tắc chung của MISA (BackEnd.SKILL) không lặp lại ở đây, chỉ ghi đặc thù riêng của dự án này.
